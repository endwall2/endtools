...
# DESCRIPTION: Append a correct protocol extension to an ip for use in a script
#
# AUTHOR:  THE ENDWARE DEVELOPEMENT TEAM
# CREATION DATE: February 06 2017
# VERSION: 0.02
# REVISION DATE: FEBRUARY 11 2017
# COPYRIGHT: THE ENDWARE DEVELOPMENT TEAM, 2016
# 
# CHANGE LOG:  - File Creation
#              - Headers, version info
#
########################################################################################################################################
# DEPENDENCIES: echo
########################################################################################################################################
...
#  $  mkdir ~/bin
#  $  cd ~/bin
#  $  wget https://github.com/endwall2/endware/raw/master/protofix.sh
#  $  chmod u+wrx protofix.sh
#  $  mv proxyload.sh protofix
#  $  export PATH=$PATH:/$HOME/bin
#      
#     Run Protofix 
#  $ protofix http ssl_proxies.txt  >> ssl_proxies_formated.txt 
#  
#############################################################################################################################################################################
#                                         ACKNOWLEDGMENTS
#############################################################################################################################################################################
